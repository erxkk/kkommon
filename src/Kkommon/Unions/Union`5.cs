...
{
    /// <summary>
    /// A type that contains a value of one of the types from <typeparamref name="T1"/> to <typeparamref name="T5"/>
    /// </summary>
    public abstract class Union<T1, T2, T3, T4, T5>
    {
        /// <summary>
        /// Creates a new <see cref="Union{T1, T2, T3, T4, T5}"/> that holds the given value
        /// </summary>
        private Union() { }
        ...
        {
            /// <summary>
            /// The underlying value this <see cref="Union{T1, T2, T3, T4, T5}"/> is holding
            /// </summary>
            public T1 Value { get; }
